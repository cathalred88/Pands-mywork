...
From there, the data is used to define several types of graphic plots in sequenced groups 
  ...
  - last is a pairplot showing the relationship interactions of each data subset against each other subset - take, for instance, petal length vs sepal width for each species. This allows for a dense visual plot that may be used for the display of exhaustive interactions between datasets. 
